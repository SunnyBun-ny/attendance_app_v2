...
class CustomFontStyle {
  ...
  static paraSSemi(Color color) => TextStyle(
      fontSize: 14, fontWeight: FontWeight.w600, height: 1.3, color: color);
  ...
  static h3Semi(Color color) => TextStyle(
      ...
      color: color,
      letterSpacing: 2);
  static subtitleBold(Color color) => TextStyle(
        fontSize: 20,
        fontWeight: FontWeight.w700,
        height: 1.01,
        color: color,
      );
  static subtitleMedium(Color color) => TextStyle(
        fontSize: 20,
        fontWeight: FontWeight.w500,
        height: 1.01,
        color: color,
      );
  static subtitleRegular(Color color) => TextStyle(
        fontSize: 20,
        fontWeight: FontWeight.w400,
        height: 1.01,
        color: color,
      );
  static captionM(Color color) => TextStyle(
        fontSize: 14,
        fontWeight: FontWeight.w500,
        height: 1.01,
        color: color,
      );
  static captionR(Color color) => TextStyle(
        fontSize: 14,
        fontWeight: FontWeight.w400,
        height: 1.01,
        color: color,
